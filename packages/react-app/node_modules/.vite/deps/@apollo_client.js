...
function useLazyQuery(query, options) {
  ...
  var execute3 = React7.useCallback(function(executeOptions) {
...
function useMutation(mutation, options) {
  ...
  var execute3 = React8.useCallback(function(executeOptions) {
...
function useSuspenseQuery(query, options) {
  ...
  var subscribeToMore = React16.useCallback(function(options2) {
...
function useBackgroundQuery(query, options) {
  ...
  var _b = React17.useState(function() {
    return /* @__PURE__ */ new Map([[queryRef.key, queryRef.promise]]);
  }), promiseCache = _b[0], setPromiseCache = _b[1];
  if (queryRef.didChangeOptions(watchQueryOptions)) {
  ...
  var wrappedQueryRef = React17.useMemo(function() {
