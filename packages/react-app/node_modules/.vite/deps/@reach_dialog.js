import {
  __assign,
  __rest
} from "./chunk-VTILXMC5.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-LGLDG3YL.js";
import {
  require_prop_types
} from "./chunk-4U67VSTC.js";
import {
  require_react_dom
} from "./chunk-JCNTK7WI.js";
import {
  _extends,
  _inheritsLoose
} from "./chunk-7L6PDVSR.js";
import {
  require_react
...
function useComposedRefs(...refs) {
  return (0, import_react2.useCallback)((node2) => {
    for (let ref of refs) {
      assignRef(ref, node2);
    }
  }, refs);
...
var useIsomorphicLayoutEffect2 = typeof window !== "undefined" ? React3.useLayoutEffect : React3.useEffect;
  ...
  return function wrap(WrappedComponent) {
    ...
    var SideEffect = function(_PureComponent) {
      ...
      _proto.render = function render() {
        return import_react18.default.createElement(WrappedComponent, this.props);
      };
      return SideEffect2;
...
var RemoveScroll = React15.forwardRef(function(props, parentRef) {
  ...
  return React15.createElement(
    ...
    forwardProps ? React15.cloneElement(React15.Children.only(children), __assign2({}, containerProps, { ref: containerRef })) : React15.createElement(Container, __assign2({}, containerProps, { className, ref: containerRef }), children)
  );
});
...
var ReactRemoveScroll = React19.forwardRef(function(props, ref) {
  return React19.createElement(RemoveScroll, __assign2({}, props, { ref, sideCar: sidecar_default }));
});
ReactRemoveScroll.classNames = RemoveScroll.classNames;
var Combination_default2 = ReactRemoveScroll;

// ../../node_modules/@reach/dialog/dist/reach-dialog.mjs
var [DialogContextProvider, useDialogContext] = createContext2("DialogContext", {
  isOpen: false
});
function DialogWrapper({
  ...
  return React20.createElement(Portal, {
    ...
    ...props
  }, React20.createElement(DialogContextProvider, {
    isOpen
  }, children));
}
DialogWrapper.displayName = "unstable_DialogWrapper";
var DialogInner = React20.forwardRef(function DialogInner2({
  allowPinchZoom,
  as: Comp = "div",
  ...
  const mouseDownTarget = React20.useRef(null);
  const overlayNode = React20.useRef(null);
  const ref = useComposedRefs(overlayNode, forwardedRef);
  const activateFocusLock = React20.useCallback(() => {
  ...
  return React20.createElement(es2015_default2, {
    autoFocus: true,
    returnFocus: true,
...
var DialogOverlay = React20.forwardRef(function DialogOverlay2({ as: Comp = "div", isOpen = true, ...props }, forwardedRef) {
  return isOpen ? React20.createElement(DialogWrapper, {
    isOpen
  }, React20.createElement(DialogInner, {
...
var DialogContent = React20.forwardRef(function DialogContent2({ as: Comp = "div", onClick, onKeyDown, ...props }, forwardedRef) {
...
var Dialog = React20.forwardRef(function Dialog2({
  ...
  return React20.createElement(DialogOverlay, {
    allowPinchZoom,
    initialFocusRef,
    isOpen,
    onDismiss
  }, React20.createElement(DialogContent, {
    ref: forwardedRef,
    ...props
  }));
});
...
function createAriaHider(dialogNode) {
  ...
  Array.prototype.forEach.call(ownerDocument.querySelectorAll("body > *"), (node2) => {
    var _a, _b;
    const portalNode = (_b = (_a = dialogNode.parentNode) == null ? void 0 : _a.parentNode) == null ? void 0 : _b.parentNode;
    if (node2 === portalNode) {
      return;
    }
    let attr = node2.getAttribute("aria-hidden");
...
@reach/dialog/dist/reach-dialog.mjs:
  (**
    ...
    *)
*/
//# sourceMappingURL=@reach_dialog.js.map
