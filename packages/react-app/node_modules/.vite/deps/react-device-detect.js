...
var require_main = __commonJS({
  "../../node_modules/react-device-detect/main.js"(exports) {
    ...
    var checkType = function checkType2(type2) {
      switch (type2) {
    ...
    var broPayload = function broPayload2(isBrowser2, browser2, engine2, os2, ua2) {
      return {
    ...
    var stvPayload = function stvPayload2(isSmartTV2, engine2, os2, ua2) {
      return {
    ...
    var wearPayload = function wearPayload2(isWearable2, engine2, os2, ua2) {
      return {
    ...
    function deviceDetect() {
      var isBrowser2 = type.isBrowser, isMobile2 = type.isMobile, isTablet2 = type.isTablet, isSmartTV2 = type.isSmartTV, isConsole2 = type.isConsole, isWearable2 = type.isWearable;
      if (isBrowser2) {
        return broPayload(isBrowser2, browser, engine, os, ua);
      }
      if (isSmartTV2) {
        return stvPayload(isSmartTV2, engine, os, ua);
      }
      if (isConsole2) {
        return consolePayload(isConsole2, engine, os, ua);
      }
      if (isMobile2) {
      ...
      if (isWearable2) {
        return wearPayload(isWearable2, engine, os, ua);
      }
    }
    var isMobileType = function isMobileType2() {
      return device.type === DeviceTypes.Mobile;
    };
    var isTabletType = function isTabletType2() {
      return device.type === DeviceTypes.Tablet;
    };
    var isMobileAndTabletType = function isMobileAndTabletType2() {
      switch (device.type) {
        case DeviceTypes.Mobile:
        case DeviceTypes.Tablet:
          return true;
    ...
    var isEdgeChromiumType = function isEdgeChromiumType2() {
      return typeof ua === "string" && ua.indexOf("Edg/") !== -1;
    };
    var isSmartTVType = function isSmartTVType2() {
      return device.type === DeviceTypes.SmartTv;
    };
    var isBrowserType = function isBrowserType2() {
      return device.type === DeviceTypes.Browser;
    };
    var isWearableType = function isWearableType2() {
      return device.type === DeviceTypes.Wearable;
    };
    var isConsoleType = function isConsoleType2() {
      return device.type === DeviceTypes.Console;
    };
    var isAndroidType = function isAndroidType2() {
      return os.name === OsTypes.Android;
    };
    var isWindowsType = function isWindowsType2() {
      return os.name === OsTypes.Windows;
    };
    var isMacOsType = function isMacOsType2() {
      return os.name === OsTypes.MAC_OS;
    };
    var isWinPhoneType = function isWinPhoneType2() {
      return os.name === OsTypes.WindowsPhone;
    };
    var isIOSType = function isIOSType2() {
      return os.name === OsTypes.IOS;
    };
    var isChromeType = function isChromeType2() {
      return browser.name === BrowserTypes.Chrome;
    };
    var isFirefoxType = function isFirefoxType2() {
      return browser.name === BrowserTypes.Firefox;
    };
    var isChromiumType = function isChromiumType2() {
      return browser.name === BrowserTypes.Chromium;
    };
    var isEdgeType = function isEdgeType2() {
      return browser.name === BrowserTypes.Edge;
    };
    var isYandexType = function isYandexType2() {
      return browser.name === BrowserTypes.Yandex;
    };
    var isSafariType = function isSafariType2() {
      return browser.name === BrowserTypes.Safari || browser.name === BrowserTypes.MobileSafari;
    };
    var isMobileSafariType = function isMobileSafariType2() {
      return browser.name === BrowserTypes.MobileSafari;
    };
    var isOperaType = function isOperaType2() {
      return browser.name === BrowserTypes.Opera;
    };
    var isIEType = function isIEType2() {
      return browser.name === BrowserTypes.InternetExplorer || browser.name === BrowserTypes.Ie;
    };
    var isMIUIType = function isMIUIType2() {
      return browser.name === BrowserTypes.MIUI;
    };
    var isSamsungBrowserType = function isSamsungBrowserType2() {
    ...
    var getBrowserFullVersion = function getBrowserFullVersion2() {
      return setDefaults(browser.version);
    };
    var getBrowserVersion = function getBrowserVersion2() {
      return setDefaults(browser.major);
    };
    var getOsVersion = function getOsVersion2() {
      return setDefaults(os.version);
    };
    var getOsName = function getOsName2() {
      return setDefaults(os.name);
    };
    var getBrowserName = function getBrowserName2() {
      return setDefaults(browser.name);
    };
    var getMobileVendor = function getMobileVendor2() {
      return setDefaults(device.vendor);
    };
    var getMobileModel = function getMobileModel2() {
      return setDefaults(device.model);
    };
    var getEngineName = function getEngineName2() {
      return setDefaults(engine.name);
    };
    var getEngineVersion = function getEngineVersion2() {
      return setDefaults(engine.version);
    };
    var getUseragent = function getUseragent2() {
      return setDefaults(ua);
    };
    var getDeviceType = function getDeviceType2() {
    ...
    var AndroidView = function AndroidView2(_ref) {
      var renderWithFragment = _ref.renderWithFragment, children = _ref.children, viewClassName = _ref.viewClassName, style = _ref.style, props = _objectWithoutProperties(_ref, ["renderWithFragment", "children", "viewClassName", "style"]);
    ...
    var BrowserView = function BrowserView2(_ref2) {
      var renderWithFragment = _ref2.renderWithFragment, children = _ref2.children, viewClassName = _ref2.viewClassName, style = _ref2.style, props = _objectWithoutProperties(_ref2, ["renderWithFragment", "children", "viewClassName", "style"]);
    ...
    var IEView = function IEView2(_ref3) {
      var renderWithFragment = _ref3.renderWithFragment, children = _ref3.children, viewClassName = _ref3.viewClassName, style = _ref3.style, props = _objectWithoutProperties(_ref3, ["renderWithFragment", "children", "viewClassName", "style"]);
    ...
    var IOSView = function IOSView2(_ref4) {
      var renderWithFragment = _ref4.renderWithFragment, children = _ref4.children, viewClassName = _ref4.viewClassName, style = _ref4.style, props = _objectWithoutProperties(_ref4, ["renderWithFragment", "children", "viewClassName", "style"]);
    ...
    var MobileView = function MobileView2(_ref5) {
      var renderWithFragment = _ref5.renderWithFragment, children = _ref5.children, viewClassName = _ref5.viewClassName, style = _ref5.style, props = _objectWithoutProperties(_ref5, ["renderWithFragment", "children", "viewClassName", "style"]);
    ...
    var TabletView = function TabletView2(_ref6) {
      var renderWithFragment = _ref6.renderWithFragment, children = _ref6.children, viewClassName = _ref6.viewClassName, style = _ref6.style, props = _objectWithoutProperties(_ref6, ["renderWithFragment", "children", "viewClassName", "style"]);
    ...
    var WinPhoneView = function WinPhoneView2(_ref7) {
      var renderWithFragment = _ref7.renderWithFragment, children = _ref7.children, viewClassName = _ref7.viewClassName, style = _ref7.style, props = _objectWithoutProperties(_ref7, ["renderWithFragment", "children", "viewClassName", "style"]);
    ...
    var SmartTVView = function SmartTVView2(_ref9) {
      var renderWithFragment = _ref9.renderWithFragment, children = _ref9.children, viewClassName = _ref9.viewClassName, style = _ref9.style, props = _objectWithoutProperties(_ref9, ["renderWithFragment", "children", "viewClassName", "style"]);
    ...
    var ConsoleView = function ConsoleView2(_ref10) {
      var renderWithFragment = _ref10.renderWithFragment, children = _ref10.children, viewClassName = _ref10.viewClassName, style = _ref10.style, props = _objectWithoutProperties(_ref10, ["renderWithFragment", "children", "viewClassName", "style"]);
    ...
    var WearableView = function WearableView2(_ref11) {
      var renderWithFragment = _ref11.renderWithFragment, children = _ref11.children, viewClassName = _ref11.viewClassName, style = _ref11.style, props = _objectWithoutProperties(_ref11, ["renderWithFragment", "children", "viewClassName", "style"]);
